...
function constants_map() {
    ...
    c.NAZZHUB_VERSION = env("NAZZHUB_VERSION", env("FORKOP_VERSION", "__COMPILED_VERSION_VARIABLE__"));
    c.NAZZHUB_CONFIG_NAME = env("NAZZHUB_CONFIG_NAME", env("FORKOP_CONFIG_NAME", "nazzhub"));
    c.NAZZHUB_CONFIG = env("NAZZHUB_CONFIG", env("FORKOP_CONFIG", "/etc/config/" + c.NAZZHUB_CONFIG_NAME));
    c.NAZZHUB_BIN = env("NAZZHUB_BIN", env("FORKOP_BIN", "/usr/bin/nazzhub"));
    c.NAZZHUB_SERVICE_NAME = env("NAZZHUB_SERVICE_NAME", env("FORKOP_SERVICE_NAME", "nazzhub"));
    c.NAZZHUB_SERVICE_INIT = env("NAZZHUB_SERVICE_INIT", env("FORKOP_SERVICE_INIT", "/etc/init.d/nazzhub"));
    c.NAZZHUB_RELEASE_REPO = env("NAZZHUB_RELEASE_REPO", env("FORKOP_RELEASE_REPO", "dedderos-prog/nazzhub"));
    c.NAZZHUB_LUCI_VIEW_NAMESPACE = env("NAZZHUB_LUCI_VIEW_NAMESPACE", env("FORKOP_LUCI_VIEW_NAMESPACE", "nazzhub"));
    c.NAZZHUB_LUCI_VIEW_DIR = env("NAZZHUB_LUCI_VIEW_DIR", env("FORKOP_LUCI_VIEW_DIR", "/www/luci-static/resources/view/" + c.NAZZHUB_LUCI_VIEW_NAMESPACE));
    c.NAZZHUB_LUCI_I18N_DOMAIN = env("NAZZHUB_LUCI_I18N_DOMAIN", env("FORKOP_LUCI_I18N_DOMAIN", "nazzhub"));

    // Legacy aliases for internal components
    c.FORKOP_VERSION = c.NAZZHUB_VERSION;
    c.FORKOP_CONFIG_NAME = c.NAZZHUB_CONFIG_NAME;
    c.FORKOP_CONFIG = c.NAZZHUB_CONFIG;
    c.FORKOP_BIN = c.NAZZHUB_BIN;
    c.FORKOP_SERVICE_NAME = c.NAZZHUB_SERVICE_NAME;
    c.FORKOP_SERVICE_INIT = c.NAZZHUB_SERVICE_INIT;
    c.FORKOP_RELEASE_REPO = c.NAZZHUB_RELEASE_REPO;
    c.FORKOP_LUCI_VIEW_NAMESPACE = c.NAZZHUB_LUCI_VIEW_NAMESPACE;
    c.FORKOP_LUCI_VIEW_DIR = c.NAZZHUB_LUCI_VIEW_DIR;
    c.FORKOP_LUCI_I18N_DOMAIN = c.NAZZHUB_LUCI_I18N_DOMAIN;
    ...
    c.RT_TABLE_NAME = env("RT_TABLE_NAME", "nazzhub");

    c.NFT_TABLE_NAME = env("NFT_TABLE_NAME", "NazzhubTable");
    c.NFT_LOCALV4_SET_NAME = env("NFT_LOCALV4_SET_NAME", "localv4");
    c.NFT_LOCALV6_SET_NAME = env("NFT_LOCALV6_SET_NAME", "localv6");
    c.NFT_COMMON_SET_NAME = env("NFT_COMMON_SET_NAME", "nazzhub_subnets");
    c.NFT_COMMON6_SET_NAME = env("NFT_COMMON6_SET_NAME", "nazzhub_subnets6");
    c.NFT_PORT_SET_NAME = env("NFT_PORT_SET_NAME", "nazzhub_ports");
    c.NFT_IP_PORT_SET_NAME = env("NFT_IP_PORT_SET_NAME", "nazzhub_ip_ports");
    c.NFT_IP_PORT6_SET_NAME = env("NFT_IP_PORT6_SET_NAME", "nazzhub_ip6_ports");
    c.NFT_DISCORD_SET_NAME = env("NFT_DISCORD_SET_NAME", "nazzhub_discord_subnets");
    c.NFT_DISCORD6_SET_NAME = env("NFT_DISCORD6_SET_NAME", "nazzhub_discord_subnets6");
    c.NFT_INTERFACE_SET_NAME = env("NFT_INTERFACE_SET_NAME", "nazzhub_interfaces");
    ...
    c.SB_MANAGED_SERVICE_MARKER = env("SB_MANAGED_SERVICE_MARKER", "NAZZHUB managed sing-box service for binary variants");
    ...
    c.SB_VARIANT_STATE_FILE = env("SB_VARIANT_STATE_FILE", "/etc/nazzhub/sing-box-variant");
    c.SB_VERSION_STATE_FILE = env("SB_VERSION_STATE_FILE", "/etc/nazzhub/sing-box-version");
    ...
    c.ZAPRET_LEGACY_RUNTIME_BASE_DIR = env("ZAPRET_LEGACY_RUNTIME_BASE_DIR", "/var/run/nazzhub/zapret-runtime");
    c.ZAPRET_NFQWS_BIN = env("ZAPRET_NFQWS_BIN", c.ZAPRET_PROVIDER_NFQWS_BIN);
    c.ZAPRET_STATE_DIR = env("ZAPRET_STATE_DIR", "/var/run/nazzhub/zapret");
    ...
    c.ZAPRET2_STATE_DIR = env("ZAPRET2_STATE_DIR", "/var/run/nazzhub/zapret2");
    ...
    c.BYEDPI_STATE_DIR = env("BYEDPI_STATE_DIR", "/var/run/nazzhub/byedpi");
