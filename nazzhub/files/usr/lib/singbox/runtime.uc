...
const SB_VERSION_STATE_FILE = getenv("SB_VERSION_STATE_FILE") || "/etc/nazzhub/sing-box-version";
...
function service_listen_address_value(settings) {
    ...
    log_message("Failed to determine the listening IP address. Please open an issue to report this problem: https://github.com/dedderos-prog/nazzhub/issues", "error");
    return "";
}
