  ...
  return E(
    ...
    [
      E(
        ...
        _(
          "NAZZHUB service is stopped. Start the service to display the dashboard."
        )
      ),
...
var COMPONENT_ACTION_STATE_DIR = "/var/run/nazzhub/component-actions";
  ...
  if (serviceAvailability === "stopped") {
    container.replaceChildren(
      renderConnectionsTable([], {
        text: _(
          "NAZZHUB service is stopped. Start the service to display connections."
        )
      })
    );
    return;
...
function getExpectedLatestVersionForAction(button) {
  if (button.component !== "nazzhub" || button.action !== "install") {
    return void 0;
  }
