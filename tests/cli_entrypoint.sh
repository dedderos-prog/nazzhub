...
show_version_out="$(NAZZHUB_LIB="$fake_lib" ucode "$NAZZHUB_BIN" show_version)"
[ "$show_version_out" = $'diagnostics\tshow-version\t\t\t' ] ||
  fail "show_version must dispatch through diagnostics/runtime.uc"

subscription_out="$(NAZZHUB_LIB="$fake_lib" ucode "$NAZZHUB_BIN" subscription_update proxy 2)"
...
component_out="$(NAZZHUB_LIB="$fake_lib" ucode "$NAZZHUB_BIN" component_action sing_box update)"
...
component_check_cache_out="$(NAZZHUB_LIB="$fake_lib" ucode "$NAZZHUB_BIN" component_update_check_cache)"
...
component_updates_out="$(NAZZHUB_LIB="$fake_lib" ucode "$NAZZHUB_BIN" component_updates_if_due)"
