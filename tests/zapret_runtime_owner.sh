...
ZAPRET_RUNTIME="$NAZZHUB_LIB/providers/zapret/runtime.uc"
ZAPRET2_RUNTIME="$NAZZHUB_LIB/providers/zapret2/runtime.uc"
ZAPRET_COMMON="$NAZZHUB_LIB/providers/zapret/common.uc"
ZAPRET2_COMMON="$NAZZHUB_LIB/providers/zapret2/common.uc"
NFQUEUE_RUNTIME="$NAZZHUB_LIB/providers/nfqueue/runtime.uc"
NFQUEUE_CHECK="$NAZZHUB_LIB/providers/nfqueue/check.uc"
NFQUEUE_VALIDATOR="$NAZZHUB_LIB/providers/nfqueue/validator.uc"
ZAPRET2_CHECK="$NAZZHUB_LIB/providers/zapret2/check.uc"
ZAPRET2_VALIDATOR="$NAZZHUB_LIB/providers/zapret2/validator.uc"
...
[ ! -e "$NAZZHUB_LIB/zapret.sh" ] ||
  fail "zapret.sh shell owner must be removed"
[ ! -e "$NAZZHUB_LIB/zapret2.sh" ] ||
...
if grep -R -n -E 'providers\.zapret\.|providers/zapret/' "$NAZZHUB_LIB/providers/zapret2" >/dev/null 2>&1; then
...
check_json="$(ucode -L "$NAZZHUB_LIB" "$ZAPRET2_RUNTIME" check)"
