...
grep -Fq '/usr/bin/nazzhub component_action sing_box "$action"' "$INSTALLER" ||
...
grep -Fq 'ucode -L /usr/lib/nazzhub /usr/lib/nazzhub/config/migration.uc migrate-podkop' "$INSTALLER" ||
