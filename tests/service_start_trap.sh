...
INITD_UC="$ROOT_DIR/nazzhub/files/usr/lib/service/initd.uc"
STATE_UC="$ROOT_DIR/nazzhub/files/usr/lib/service/state.uc"
UI_UC="$ROOT_DIR/nazzhub/files/usr/lib/service/ui.uc"
UPDATES_UC="$ROOT_DIR/nazzhub/files/usr/lib/components/updates.uc"
SUBSCRIPTION_CACHE_UC="$ROOT_DIR/nazzhub/files/usr/lib/subscription/cache.uc"
NFQUEUE_RUNTIME_UC="$ROOT_DIR/nazzhub/files/usr/lib/providers/nfqueue/runtime.uc"
BYEDPI_RUNTIME_UC="$ROOT_DIR/nazzhub/files/usr/lib/providers/byedpi/runtime.uc"
PRIORITY_UC="$ROOT_DIR/nazzhub/files/usr/lib/singbox/priority.uc"
...
reject_pattern() {
  ...
  ! grep -Fq "$pattern" "$NAZZHUB_BIN" || fail "$label"
}
