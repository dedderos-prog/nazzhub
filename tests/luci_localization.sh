...
SOURCE_PO="$ROOT_DIR/fe-app-nazzhub/locales/forkop.ru.po"
PACKAGE_PO="$ROOT_DIR/luci-app-nazzhub/po/ru/forkop.po"
SOURCE_POT="$ROOT_DIR/fe-app-nazzhub/locales/forkop.pot"
PACKAGE_POT="$ROOT_DIR/luci-app-nazzhub/po/templates/forkop.pot"
CALLS_JSON="$ROOT_DIR/fe-app-nazzhub/locales/calls.json"
